...
from greenroom.apps.django_facebook_patched.utils import mass_get_or_create, cleanup_oauth_url,\
    get_profile_class
...
class FacebookUserConverter(object):
    ...
    def get_and_store_likes(self, user):
        ...
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from greenroom.apps.django_facebook_patched.tasks import get_and_store_likes
    ...
    def store_likes(self, user, likes):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from greenroom.apps.django_facebook_patched.tasks import store_likes
    ...
    def get_and_store_friends(self, user):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from greenroom.apps.django_facebook_patched.tasks import get_and_store_friends
    ...
    def store_friends(self, user, friends):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from greenroom.apps.django_facebook_patched.tasks import store_friends

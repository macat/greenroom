...
from greenroom.apps.django_facebook_patched.utils import (get_registration_backend, get_form_class,
                                   get_profile_class)
import urllib2
...
def _register_user(request, facebook, profile_callback=None,
    ...
    new_user.backend = 'greenroom.apps.django_facebook_patched.auth_backends.FacebookBackend'

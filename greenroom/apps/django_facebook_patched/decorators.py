...
from greenroom.apps.django_facebook_patched import settings as fb_settings

from django.http import HttpResponseRedirect
from greenroom.apps.django_facebook_patched.utils import get_oauth_url, parse_scope, response_redirect
from django.utils.decorators import available_attrs
from django.utils.functional import wraps

import logging
from greenroom.apps.django_facebook_patched.api import require_persistent_graph, get_persistent_graph
...
def facebook_required(view_func=None, scope=fb_settings.FACEBOOK_DEFAULT_SCOPE,
    ...
    from greenroom.apps.django_facebook_patched.utils import test_permissions

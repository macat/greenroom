...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('greenroom.apps.django_facebook_patched_facebookuser', (
        ...
        db.send_create_signal('greenroom.apps.django_facebook_patched', ['FacebookUser'])

        # Adding unique constraint on 'FacebookUser', fields ['user_id', 'facebook_id']
        db.create_unique('greenroom.apps.django_facebook_patched_facebookuser', ['user_id', 'facebook_id'])

        # Adding model 'FacebookLike'
        db.create_table('greenroom.apps.django_facebook_patched_facebooklike', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')()),
            ('facebook_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal('greenroom.apps.django_facebook_patched', ['FacebookLike'])

        # Adding unique constraint on 'FacebookLike', fields ['user_id', 'facebook_id']
        db.create_unique('greenroom.apps.django_facebook_patched_facebooklike', ['user_id', 'facebook_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookLike', fields ['user_id', 'facebook_id']
        db.delete_unique('greenroom.apps.django_facebook_patched_facebooklike', ['user_id', 'facebook_id'])

        # Removing unique constraint on 'FacebookUser', fields ['user_id', 'facebook_id']
        db.delete_unique('greenroom.apps.django_facebook_patched_facebookuser', ['user_id', 'facebook_id'])

        # Deleting model 'FacebookUser'
        db.delete_table('greenroom.apps.django_facebook_patched_facebookuser')

        # Deleting model 'FacebookLike'
        db.delete_table('greenroom.apps.django_facebook_patched_facebooklike')
    ...
    models = {
        ...
        'greenroom.apps.django_facebook_patched.facebooklike': {
        ...
        'greenroom.apps.django_facebook_patched.facebookprofile': {
        ...
        'greenroom.apps.django_facebook_patched.facebookuser': {
    ...
    complete_apps = ['greenroom.apps.django_facebook_patched']
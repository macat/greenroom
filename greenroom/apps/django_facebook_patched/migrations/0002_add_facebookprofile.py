...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('greenroom.apps.django_facebook_patched_facebookprofile', (
        ...
        db.send_create_signal('greenroom.apps.django_facebook_patched', ['FacebookProfile'])


    def backwards(self, orm):

        # Deleting model 'FacebookProfile'
        db.delete_table('greenroom.apps.django_facebook_patched_facebookprofile')

...
from greenroom.apps.django_facebook_patched import model_managers
...
class FacebookProfileModel(models.Model):
    ...
    def post_facebook_registration(self, request):
        ...
        '''
        from greenroom.apps.django_facebook_patched.utils import next_redirect
...
class FacebookProfile(FacebookProfileModel):
    ...
    Use this by setting
    AUTH_PROFILE_MODULE = 'greenroom.apps.django_facebook_patched.FacebookProfile' 
    '''

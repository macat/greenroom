...
from greenroom.apps.django_facebook_patched import exceptions as facebook_exceptions
from greenroom.apps.django_facebook_patched.auth_backends import FacebookBackend
from greenroom.apps.django_facebook_patched.connect import (_register_user, connect_user,
                                     CONNECT_ACTIONS)
from greenroom.apps.django_facebook_patched.tests_utils.base import FacebookTest, LiveFacebookTest
from greenroom.apps.django_facebook_patched.utils import get_profile_class
from greenroom.apps.django_facebook_patched.api import (get_facebook_graph, FacebookUserConverter,
                                 get_persistent_graph)
from greenroom.apps.django_facebook_patched import signals
import logging
from open_facebook.api import FacebookConnection, FacebookAuthorization,\
    OpenFacebook
from functools import partial
from greenroom.apps.django_facebook_patched.utils import cleanup_oauth_url
from greenroom.apps.django_facebook_patched.tests_utils.base import RequestMock
...
__doctests__ = ['greenroom.apps.django_facebook_patched.api']
...
class UserConnectTest(FacebookTest):
    ...
    def test_registration_form(self):
        '''
        greenroom.apps.django_facebook_patched should use user supplied registration form if given
        '''
        facebook_settings.FACEBOOK_REGISTRATION_FORM = 'greenroom.apps.django_facebook_patched.tests_utils.forms.SignupForm'
        facebook = get_facebook_graph(access_token='short_username')
        action, user = connect_user(self.request, facebook_graph=facebook)

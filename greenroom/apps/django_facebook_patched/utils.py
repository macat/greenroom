...
from greenroom.apps.django_facebook_patched.registration_backends import FacebookRegistrationBackend
...
class CanvasRedirect(HttpResponse):
    ...
    def __init__(self, redirect_to):
        ...
        js_redirect = render_to_string('greenroom.apps.django_facebook_patched/canvas_redirect.html', context)

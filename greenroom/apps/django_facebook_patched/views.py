...
from greenroom.apps.django_facebook_patched.api import get_persistent_graph, FacebookUserConverter, \
    require_persistent_graph
from greenroom.apps.django_facebook_patched.canvas import generate_oauth_url
from greenroom.apps.django_facebook_patched.connect import CONNECT_ACTIONS, connect_user
from greenroom.apps.django_facebook_patched.utils import next_redirect, get_registration_backend,\
    replication_safe
from greenroom.apps.django_facebook_patched.decorators import (facebook_required,
...
def connect_async_ajax(request):
    ...
    '''
    from greenroom.apps.django_facebook_patched import tasks as facebook_tasks
...
def canvas(request):
    ...
    return render_to_response('greenroom.apps.django_facebook_patched/canvas.html', context)
...
def page_tab(request):
    ...
    return render_to_response('greenroom.apps.django_facebook_patched/page_tab.html', context)

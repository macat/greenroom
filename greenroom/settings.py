...
STATICFILES_STORAGE = 'greenroom.libs.staticfile_storage.S3PipelineStorage' if not DEBUG else 'pipeline.storage.PipelineCachedStorage'
PIPELINE = True
...
STATIC_URL = 'https://s3.amazonaws.com/%s/' % AWS_STORAGE_BUCKET_NAME if not DEBUG else '/static/'
